...
Opens [http://127.0.0.1:1916/](http://127.0.0.1:1916/) — front (with tag filters), treasury, docket, flags, stats, provenance, citizens, browser watchlist, `/{handle}` public cards, Human chat guestbook.
